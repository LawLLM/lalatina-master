...
class HelpCog(commands.Cog, name="Help"):
    ...
    async def help(self, ctx, arg=None):
        ...
        if not arg:
            embed.description = (
                f"Usa `{PREFIX}help <comando>` para ver más información detallada"
            )
            embed.add_field(
                name="Cumpleaños", value="`setbirthday` `calendar`", inline=False
            )
            embed.add_field(
                name="Roles (colores)", value="`iam` `iamnot`", inline=False
            )
            ...
            embed.add_field(
                name="Otros Comandos",
                value="`yt` `autoreactionlist` `autoreplylist`",
                inline=False,
            )
            ...
            if ctx.author.id in self.bot.get_panchessco_staff_id_list():
                embed.add_field(
                    name="Config",
                    value="`addautoreaction` `deleteautoreaction` `addautoreply` `deleteautoreply`",
                )
            ...
            embed.set_image(
                url="https://cdn.discordapp.com/attachments/718133124680253614/869874282392616980/unknown.png"
            )
            await ctx.send(embed=embed)
            ...
            embed.set_image(
                url="https://cdn.discordapp.com/attachments/718133124680253614/869875822352273428/unknown.png"
            )
            await ctx.send(embed=embed)
            ...
            embed.set_image(
                url="https://cdn.discordapp.com/attachments/718133124680253614/869879684882644992/unknown.png"
            )
            await ctx.send(embed=embed)
            ...
            embed.set_image(
                url="https://cdn.discordapp.com/attachments/718133124680253614/869880985687306270/unknown.png"
            )
            await ctx.send(embed=embed)
