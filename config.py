...
owners_id = [402291352282464259, 603024644207018001, 682674409085206621]

# Starboard
#general, ajedrez en discord, canales de voz, economia
star_board_category_channels_id = [652651049626370087, 798729997409321002, 512830421805826051, 776997219777642526]
